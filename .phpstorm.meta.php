...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/jameswang/Codes/mes-backend/public/storage' => 'string',
            ...
            'logging.channels.team_management.driver' => 'string',
            'logging.channels.team_management.path' => 'string',
            'logging.channels.team_management.level' => 'string',
            'logging.channels.team_management.days' => 'integer',
            'logging.channels.team_management.replace_placeholders' => 'boolean',
            'logging.channels.api_errors.driver' => 'string',
            'logging.channels.api_errors.path' => 'string',
            'logging.channels.api_errors.level' => 'string',
            'logging.channels.api_errors.days' => 'integer',
            'logging.channels.api_errors.replace_placeholders' => 'boolean',
            ...
            'ziggy.groups.api' => 'array',
            'ziggy.aliases.api.team-members.index' => 'string',
            'ziggy.aliases.api.team-members.store' => 'string',
            'ziggy.aliases.api.team-members.update' => 'string',
            'ziggy.aliases.api.team-members.destroy' => 'string',
...
'delete','forceDelete','denyWithStatus','denyAsNotFound',);
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/jameswang/Codes/mes-backend/public/storage','fortify.guard','fortify.middleware',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.team_management.driver',
'logging.channels.team_management.path','logging.channels.team_management.level','logging.channels.team_management.days','logging.channels.team_management.replace_placeholders','logging.channels.api_errors.driver',
'logging.channels.api_errors.path','logging.channels.api_errors.level','logging.channels.api_errors.days','logging.channels.api_errors.replace_placeholders','logging.channels.security.driver',
'logging.channels.security.path','logging.channels.security.level','logging.channels.security.days','logging.channels.security.replace_placeholders','logging.channels.deprecations.driver',
...
'permission.cache.key','permission.cache.store','permission.testing','queue.default','queue.connections.sync.driver',
...
'session.partitioned','ziggy.groups.api','ziggy.aliases.api.team-members.index','ziggy.aliases.api.team-members.store','ziggy.aliases.api.team-members.update',
'ziggy.aliases.api.team-members.destroy','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit',
...
'broadcasting.connections.null.driver','view.paths','view.compiled','ide-helper.filename','ide-helper.models_filename',
...
'ensure.team',);
        registerArgumentsSet('routes', 'password.email','password.update',
'verification.verify','verification.send','user-profile-information.update','user-password.update','password.confirmation',
'password.confirm.store','sanctum.csrf-cookie','teams.index',
'teams.store','teams.show','teams.update','teams.destroy','api.team-members.index',
'api.team-members.store','api.team-members.update','api.team-members.destroy','roles.index',
'roles.store','roles.show','roles.update','roles.destroy','permissions.index','permissions.store','permissions.show','permissions.update',
'permissions.destroy','storage.local',);
